...
export default function NurseryHero({
  ...
  return (
    ...
    >
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" fill="currentColor" className="bi bi-arrow-down-circle" viewBox="0 0 16 16">
      ...
      <span className='text-2xl mt-4 text-gray-700'> Jadcherla, Hyderabad</span>
      </h1>
